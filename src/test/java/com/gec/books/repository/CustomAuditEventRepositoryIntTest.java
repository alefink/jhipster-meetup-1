...
import com.gec.books.config.audit.AuditEventConverter;
import com.gec.books.domain.PersistentAuditEvent;
...
import static com.gec.books.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
